...
class TestBaseApi:
    def test_ssl_verification_enabled_by_default(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            ...
            assert api.session.verify == True
    ...
    def test_token_validity_check(self):
        ...
        assert api.is_token_valid() == True
...
class TestZaptecApi:
        ...
        responses.add(
            ...
            json={"Pages": 1, "Data": [{
                ...
                "ChargerFirmwareVersion": {
                    ...
                    "Revision": 0, "MajorRevision": 1, "MinorRevision": 0
                },
    ...
    def test_get_installation_report(self):
        ...
        with patch.dict('os.environ', {'ZAPTEC_INSTALLATION_ID': 'test-installation'}):
            ...
            assert report.totalUserChargerReportModel[0].TotalChargeSessionEnergy == 125.5